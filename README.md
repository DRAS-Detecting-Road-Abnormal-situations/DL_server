...
```bash
# yolov3
python detect.py --images "data/images/accident.jpg"

# yolov3-tiny
python detect.py --weights ./weights/yolov3-tiny.tf --tiny --images "data/images/accident.jpg"
...
![ex_screenshot](./detections/detection1.jpg)

# video file with output which is a first image(score > 0.7)
python detect_video.py --video path_to_file.mp4

Then you can find the output image in the 'output' folder
...
detect.py:
  --classes: path to classes file
    (default: './data/labels/classes.names')
  --images: path to input images as a string with images separated by ","
    (default: 'data/images/accident.jpg')
